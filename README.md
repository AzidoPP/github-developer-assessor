...
An evidence-first Agent Skill for assessing what a GitHub account publicly demonstrates: engineering capability, stewardship, attributable ecosystem impact, development trajectory, and—when a cohort can be defined—technology scarcity.
...
1. Verify identity and define the evidence boundary.
...
The agent works best when it can browse GitHub, search commits/issues/pull requests/reviews/releases, inspect code and diffs, and optionally use the GitHub API or CLI. It remains usable without API access, but confidence may be lower.

## Scope and privacy

The skill evaluates the stated public evidence boundary. It does not access private data, infer protected or sensitive personal characteristics, equate missing public work with weak ability, or infer market value from GitHub rarity alone.
